...
CHAT_TEMPLATES["ORIGINAL_FORMAT"] = None
...
def main(args: Args, dataset_config: DatasetConfig, model_config: ModelConfig):
    ...
    print(f"Before: {dataset_config.chat_template} - {tokenizer.chat_template}")
    if dataset_config.chat_template != "ORIGINAL_FORMAT":
        tokenizer.chat_template = CHAT_TEMPLATES[dataset_config.chat_template]
        assert tokenizer.chat_template is not None
    print(f"After:  {dataset_config.chat_template} - {tokenizer.chat_template}")
