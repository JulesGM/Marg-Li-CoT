...
def main(cfg: omegaconf.DictConfig) -> None:
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = ",".join(str(x) for x in cfg.accelerate.gpu_ids)
    ...
    train_dataset = datasets.load_dataset(dataset_name, split=dataset_split)
    ...
    inference_llm = vllm.LLM(
        model=model_name,
        trust_remote_code=True,
        gpu_id=cfg.vllm.gpu_id,  # specify GPU id for vLLM
    )
