"""
Extraction Code from Hendrycks & al.'s Math dataset.

## Source: 

> https://raw.githubusercontent.com/hendrycks/math/refs/heads/main/modeling/dataset/util.py
...
was_good_answer = is_equiv(last_boxed_only(generated), last_boxed_only(reference))
